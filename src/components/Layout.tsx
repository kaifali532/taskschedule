          ...
          <div className="flex items-center gap-5">
            <div className="hidden md:flex items-center gap-3">
               <div className="text-right">
                 <p className="text-[13px] font-medium text-white leading-tight">{profile?.name || 'User'}</p>
                 <p className="text-[11px] text-zinc-400 font-medium leading-tight mt-0.5">{profile?.role || 'Member'}</p>
               </div>
            </div>
            <div className="hidden md:block w-px h-5 bg-zinc-800"></div>
            <button
              onClick={signOut}
              className="hidden md:flex text-[13px] font-medium text-zinc-400 hover:text-white items-center gap-1.5 transition-colors"
              title="Sign Out"
            >
